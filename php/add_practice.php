...
if (db_add("INSERT INTO `practices`(`id`, `title`, `features`, `description`, `company_id`, `timestamp`) VALUES (NULL, '$practice_title', '$practice_features', '$practice_description', '$practice_company', '$datetime')")) {
