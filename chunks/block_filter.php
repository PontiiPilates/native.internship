<div class="filter-block">
  <div class="filter-block-header">
    <div>Фильтр по практикам</div>
    <img class="filter-icon filter-icon-active" src="img/expand.svg" alt="Открыть">
    <img class="filter-icon" src="img/close.svg" alt="Закрыть">
  </div>
  <div class="filter-block-content">
    <ul>
      ...
      <li class="filter-item"><input id="upr" class="checkbox" type="checkbox"><label for="upr">Управление</label></li>
